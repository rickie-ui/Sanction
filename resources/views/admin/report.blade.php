...
<h3 class="text-sky-400 text-2xl font-semibold px-12 pt-2">Report Invoice</h3>

<h4 class="px-12 py-4 text-slate-400">Sanction &ensp;/&ensp;Finances</h4>
 ...
 <div class="w-11/12 mx-auto">
     ...
     <table class="display" id="claims">
                  <thead>
                    <tr>
                      <th class="uppercase text-stone-400 text-xs font-semibold opacity-70">Report Number</th>
                      <th class="uppercase text-stone-400 text-xs font-semibold opacity-70">Employee</th>
                      <th class="uppercase text-stone-400 text-xs font-semibold opacity-70">Program</th>
                  ...
                  <tbody>
                    ...
                    <tr>
                       <td>
                        <a href="#" class="text-gray-500 font-semibold text-sm">#LA-0210</a>                   
                      </td>
                      <td>
                        <p class="text-gray-500 text-sm font-semibold mb-0">Jason Mwenda</p>
                      </td> 
                      <td>
                        <p class="text-gray-500 text-sm font-semibold mb-0">Charity foundation donations</p>
                      </td>

                      <td>
                         <p class="text-gray-500 text-sm font-semibold mb-0">07 March, 2021</p>
                      </td>
                      <td class="text-gray-500 text-sm font-semibold"> 
                        <span class="bg-teal-500 text-white border rounded-md outline-none border-0 py-1 px-2 drop-shadow-md">
							Approved
						</span>
                        </td>
                      <td>
                          <span class="text-gray-500 text-sm font-semibold">$4,205</span>
                      </td>
                      ...
                      <tr>
                       <td>
                        <a href="#" class="text-gray-500 font-semibold text-sm">#LA-0215</a>                   
                      </td>
                      <td>
                        <p class="text-gray-500 text-sm font-semibold mb-0">Jake Paul</p>
                      </td> 
                      <td>
                        <p class="text-gray-500 text-sm font-semibold mb-0">Advocate payment</p>
                      </td>

                      <td>
                         <p class="text-gray-500 text-sm font-semibold mb-0">10 March, 2021</p>
                      </td>
                      <td class="text-gray-500 text-sm font-semibold"> 
                        <span class="bg-yellow-500	 text-white border rounded-md outline-none border-0 py-1 px-2 drop-shadow-md">
							   Pending
						</span>
                        </td>
                      <td>
